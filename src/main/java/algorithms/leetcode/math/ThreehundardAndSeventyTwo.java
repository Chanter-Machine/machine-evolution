...
import algorithms.leetcode.string.ThreehundardAndEightyThree;

import java.util.HashMap;

public class ThreehundardAndSeventyTwo {
    public static void main(String[] args) {
        ThreehundardAndSeventyTwo threehundardAndSeventyTwo = new ThreehundardAndSeventyTwo();
        int a = 209253;
        ...
        int res = threehundardAndSeventyTwo.superPow(a, arr);
    ...
    public int pow(int a, int b) {
        int res = 1;
//        int res = mapping.getOrDefault(a+"_"+b, 1);
//        if (res != 1){
//            return res;
//        }
        a %=mod;
